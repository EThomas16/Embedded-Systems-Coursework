...
void themetune(void) {
	//no
	generate_Tone_On_Speaker(880, 120);
	generate_Tone_On_Speaker(698, 120);
	generate_Tone_On_Speaker(880, 120);
	generate_Tone_On_Speaker(698, 120);
	generate_Tone_On_Speaker(988, 120);
	generate_Tone_On_Speaker(784, 120);
	generate_Tone_On_Speaker(988, 120);
	generate_Tone_On_Speaker(784, 120);
	generate_Tone_On_Speaker(1047, 120);
	generate_Tone_On_Speaker(880, 120);
	generate_Tone_On_Speaker(1047, 120);
	generate_Tone_On_Speaker(880, 120);
	generate_Tone_On_Speaker(1175, 120);
	generate_Tone_On_Speaker(988, 120);
	generate_Tone_On_Speaker(1175, 120);
	generate_Tone_On_Speaker(988, 120);
	generate_Tone_On_Speaker(1047, 120);
	...
	generate_Tone_On_Speaker(1047, 300);
	generate_Tone_On_Speaker(880, 300);
	generate_Tone_On_Speaker(1047, 300);
	generate_Tone_On_Speaker(988, 300);
	generate_Tone_On_Speaker(1047, 300);
	generate_Tone_On_Speaker(988, 300);
	generate_Tone_On_Speaker(784, 300);
	delaySecs(1);
	generate_Tone_On_Speaker(880, 300);
	generate_Tone_On_Speaker(1319, 300);
	generate_Tone_On_Speaker(1175, 300);
	generate_Tone_On_Speaker(1047, 300);
	generate_Tone_On_Speaker(988, 300);
	generate_Tone_On_Speaker(1047, 300);
	generate_Tone_On_Speaker(988, 300);
...
void snakeLogic(xDir, yDir) {
    ...
    for (int i=1; i<sSnake.tailLen; i++) {
				//GLCD_DisplayString(lastY_, lastX_, __FI, " ");
        lastX_ = tailX[i];
        lastY_ = tailY[i];
        tailX[i] = lastX;
        tailY[i] = lastY;
